...
## 🚀 Featured Projects
* **[BarberShop]** - A comprehensive full-stack web application connecting clients with barbershops. Features user authentication, appointment scheduling, and a review system. *(Java, Spring Boot, React, PostgreSQL, Docker)*
* **[iTECify]** - A real-time code-collaboration and sandboxing platform built during a 72-hour hackathon. *(React, JavaScript, Ollama AI, Docker)*
* **[AI Code Reviewer]** - Developed at the Haufe Group Hackathon. An automated platform utilizing a locally hosted LLM to analyze source code and suggest improvements while ensuring data privacy.
* **[To-do List]** - Full-stack web application for task management.
* **[Formula1]** - Frontend website displaying current F1 team and driver standings.
...
<br/>
[![Backend](https://skillicons.dev/icons?i=spring,postgres,mysql,docker,azure&theme=dark)](https://skillicons.dev)
